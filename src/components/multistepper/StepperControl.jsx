...
const StepperControl = () => {
  ...
  return (
    ...
    :
    <>
    <button className={`bg-primary-bg-color text-white uppercase py-2 px-4 rounded-xl font-semibold cursor-pointer border-2 border-slate-300 hover:bg-slate-700 hover:text-white transition duration-200 ease-in-out w-max`} onClick={()=>{updateIsOpen(); updateOpenSecondModal();}}>
        Submit
    </button>
    </>
  )
